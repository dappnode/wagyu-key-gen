    ...
    <Grid container direction="column" spacing={2}>
      ...
      <Grid item>
        <FormControlLabel
          ...
          label="Use Advanced Inputs (Required for Gnosis Chain)"
        />
      </Grid>
      <Grid item>
              ...
              <Grid item>
                <Tooltip title={tooltips.ETH1_WITHDRAW_ADDRESS}>
                  <AddressTextField
                    ...
                    label="Ethereum Withdrawal Address (Optional, Unless you are creating multiple keys at once for Gnosis Chain then this field is required."
                    variant="outlined"
